...
해당 키의 값을 가지고
[metadata.zip](https://developers.nexon.com/kart/api/14/39) > `kart.json`에서 확인하실 수 있습니다.
### `license`
항상 `""`을 가집니다.
### `pet`
해당 키의 값을 가지고
[metadata.zip](https://developers.nexon.com/kart/api/14/39) > `pet.json`에서 확인하실 수 있습니다.
### `flyingPet`
해당 키의 값을 가지고
[metadata.zip](https://developers.nexon.com/kart/api/14/39) > `flyingpet.json`에서 확인하실 수 있습니다.
### `partsEngine`
